...
\footnotetext[1]{The opcodes, condition nodes, plugins, by-law script, and other designs introduced in this paper are provided as reference designs. The final released version should be referenced from the implementation in the DARC code repository on GitHub: \url{https://github.com/project-darc/darc}}
